METHOD if_oo_adt_classrun~main.
    DATA lt_event TYPE STANDARD TABLE OF /coss/uni_dumb WITH EMPTY KEY.
    ...
    TRY.
     ...
     DELETE FROM /coss/uni_dumb WHERE event_uuid IS NOT INITIAL.
     INSERT /coss/uni_dumb FROM TABLE @lt_event.
     COMMIT WORK.
